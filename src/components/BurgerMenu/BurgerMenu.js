  ...
  return (
    <section className={`burger-menu burger-menu_${isOpenBurger && 'visible'}`}>
      <ul className="burger-menu__links">
        ...
        <li className={`burger-menu__link burger-menu__link_${isOpenBurger && 'visible'}`} onClick={onCloseBurger}><a href="#rsvp" className="burger-menu__ancor">ОБРАТНАЯ СВЯЗЬ</a></li>
